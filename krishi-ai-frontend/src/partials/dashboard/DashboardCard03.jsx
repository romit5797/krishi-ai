      ...
      // Indigo line
      {
        ...
        backgroundColor: function (context) {
          ...
          return chartAreaGradient(ctx, chartArea, [
            { stop: 0, color: `rgba(${hexToRGB("#42b860")}, 0)` },
            { stop: 1, color: `rgba(${hexToRGB("#42b860")}, 0.2)` },
          ]);
        },
        borderColor: "#42b860",
        borderWidth: 2,
        pointRadius: 0,
        pointHoverRadius: 3,
        pointBackgroundColor: "#42b860",
        pointHoverBackgroundColor: "#42b860",
        pointBorderWidth: 0,
      ...
      <div className="px-5 pt-5">
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">
            {
              props.data.usersDatewise[props.data.usersDatewise.length - 1]
                .count
            }
          </div>
